...
| **Boleta interna** | Comprobante que emite DyPos CL (en pantalla, PDF o compartible por WhatsApp). **NO es boleta electrónica SII** — eso viene en una versión futura. |
...
✅ Cobrar mixto: efectivo + tarjeta + transferencia + crédito en una
   misma venta.
✅ Generar boleta interna en pantalla, PDF o compartible.
