...
description: Tracks conversation metrics: resolution rate, CSAT, escalation rate, intent coverage gaps
model: sonnet
---
...
Tracks conversation metrics: resolution rate, CSAT, escalation rate, intent coverage gaps
