...
description: Guides new tenant setup, configures defaults, tracks activation metrics
model: sonnet
---
...
Guides new tenant setup, configures defaults, tracks activation metrics
